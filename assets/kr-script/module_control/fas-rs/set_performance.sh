...
sed '/\[performance\]/,/\[fast\]/ {/^\[performance\]/b;/^\[fast\]/b;d}' /data/media/0/Android/fas-rs/games.toml  | awk '/\[performance\]/{print; print ""; next} 1' > "$temp_file" && mv "$temp_file" /data/media/0/Android/fas-rs/games.toml
